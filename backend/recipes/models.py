...
from users.constants import SLICE_LENGTH
from recipes.validators import real_amount, real_time
...
class Tag(models.Model):
    ...
    name = models.CharField(
        'Название', unique=True, max_length=32
    )

    slug = models.SlugField(
        'slug', unique=True, max_length=32
    )
...
class Ingredient(models.Model):
    ...
    name = models.CharField(
        'Название', unique=True, max_length=128
    )
